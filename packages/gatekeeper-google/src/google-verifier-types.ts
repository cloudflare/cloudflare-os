...
//
// It lives in its own module so that a gatekeeper implemented outside google.ts (Chat, Gmail)
// can name the interface without importing the module that implements it.
