 ...
 * the gadget's bootstrap -- a shared module cannot import it -- so the gadget passes it in, as it passes
...
/** What the gadget's bootstrap supplies that a shared module cannot import: the RPC layer's `RpcTarget`. */
