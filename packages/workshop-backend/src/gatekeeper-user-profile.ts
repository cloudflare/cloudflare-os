...
/**
 * Workshop-owned presentation capability for one user, handed to a gatekeeper alongside the selected
 * user's verifier (see GatekeeperUser.receiveSelectedUser).
 */
@validateRpc()
