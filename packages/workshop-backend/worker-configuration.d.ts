/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 76bfa180d67933a4c4e393181afc4e22)
...
interface __BaseEnv_Env {
	...
	LOADER: WorkerLoader;
	BROWSER: BrowserRun;
	AGENT_TURN_WORKFLOW: Workflow<Parameters<import("./src/server").AgentTurnWorkflow['run']>[0]['payload']>;
}
