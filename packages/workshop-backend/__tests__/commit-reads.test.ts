...
// OverseerInterface class: oid validation and the per-call path cap. The read semantics themselves
// are covered by git-cache.test.ts; this file covers the RPC surface -- and, because
