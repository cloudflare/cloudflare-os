...
// Renders the popover with one pending request, failing if its description never rendered.
async function renderPending(descriptionIsComplete?: true, fields?: unknown[]) {
  const server = makeOverseer()
  await view.render(<ActivityNotifications overseer={server.overseer} onViewActivity={() => {}} />)
