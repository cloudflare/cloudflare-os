...
marker over-fences admission for good — the same fail-closed trade the attempt record makes, and
the reason it has no TTL, whose expiry would reopen the window mid-read.
